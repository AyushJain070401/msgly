...
Add Dial — agent-provisioned numbers, with SMS, MMS and iMessage on one line.

**`@msgly/dial`** is the first channel here where the *number itself* is
...
silently. Reaction *removal* is deliberately not implemented: other channels use
